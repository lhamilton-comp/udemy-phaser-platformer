...
class Preload extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("level-1", "assets/level_1.json");
    this.load.tilemapTiledJSON("level-2", "assets/level_2.json");
    ...
    this.load.image("bg-sky-blue", "assets/background_0.png")
    ...
    this.load.spritesheet("player-throw",
                          "assets/player/throw_attack_sheet_1.png",
                          {frameWidth: 32, frameHeight: 38, spacing: 32});
    this.load.spritesheet("player-slide",
                          "assets/player/slide_sheet_2.png",
                          {frameWidth: 32, frameHeight: 38, spacing: 32});
    this.load.spritesheet("sword-default",
                          "assets/weapons/sword_sheet_1.png",
                          {frameWidth: 52, frameHeight: 32, spacing: 16});
    this.load.spritesheet("birdman",
                          "assets/enemy/enemy_sheet.png",
                          {frameWidth: 32, frameHeight: 64, spacing: 32});
    this.load.spritesheet("snakeman",
                          "assets/enemy/enemy_sheet_2.png",
                          {frameWidth: 32, frameHeight: 64, spacing: 32});
    this.load.spritesheet("hit",
                          "assets/weapons/hit_effect_sheet.png",
                          {frameWidth: 32, frameHeight: 32});

    this.load.audio("theme-music", "assets/music/Retro Music - WolfSynth - Tempo Normal - 02.wav");
    this.load.audio("shoot", "assets/music/projectile_launch.wav");
    this.load.audio("step", "assets/music/step_mud.wav");
    this.load.audio("jump", "assets/music/jump.wav");
    this.load.audio("swing", "assets/music/swipe.wav");
    this.load.audio("pickup", "assets/music/coin_pickup.wav");

    this.load.once("complete", this.startGame.bind(this));
  }

  startGame() {
    this.registry.set("level", 1);
    this.registry.set("progress", 1);
